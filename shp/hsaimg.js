...
var aoi = 
    ...
    ee.Geometry.Polygon(
        [[[-50.348764190384216, 67.44890607676881],
          [-50.348764190384216, 66.895905440465],
          [-48.412423858352966, 66.895905440465],
          [-48.412423858352966, 67.44890607676881]]], null, false);
// define your time period here
var date_start = ee.Date.fromYMD(2024, 8, 2);
var date_end = ee.Date.fromYMD(2024, 8, 5);
...
var map_id_dict =imgHSA.select(['Red', 'Green', 'Blue']).getMapId(visParam);
print(map_id_dict);


// Export the image, specifying the CRS, transform, and region.
Export.image.toDrive({
  image: imgHSA.select(['Blue', 'Green', 'Red']),
  description: 'dp24',
  folder:'export',
  scale:30,
  crs: 'EPSG:3413', // change your CRS here
