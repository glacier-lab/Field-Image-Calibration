...
% =========================================================================
% DESCRIPTION:
%   This script performs color calibration on raw format images using a
%   Color Checker reference. It reads raw images and applies color
...
%   dependencies are in the MATLAB path and input raw images are in the
%   expected directory.
%
%
